...
def login():
    ...
    Button(root_login, text="Login", command=ClicktoLogin, width=20, bg='firebrick',
           fg='white').place(x=100, y=230)
    Button(root_login, text="Registration", command=registration, width=20, bg='firebrick',
